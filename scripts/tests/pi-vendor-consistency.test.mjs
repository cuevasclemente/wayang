...
test("vendored Pi coding-agent package, lockfile, artifact, and documentation stay aligned", () => {
  ...
  const match = /^file:(earendil-works-pi-coding-agent-(0\.(?:84\.1|85\.0)-wayang\.[a-f0-9]{8})\.tgz)$/u.exec(specification);
...
test("vendored Pi core matches the SDK source revision and locked artifact bytes", () => {
  ...
  const match = /^file:(earendil-works-pi-agent-core-(0\.(?:84\.1|85\.0))-wayang\.([a-f0-9]{8})\.tgz)$/u.exec(specification);
...
test("vendored Pi AI package, lockfile, artifact, and documentation stay aligned", () => {
  ...
  assert.equal(typeof specification, "string");
  const match = /^file:(earendil-works-pi-ai-(0\.(?:84\.1|85\.0))-wayang\.([a-f0-9]{8})\.tgz)$/u.exec(specification);
